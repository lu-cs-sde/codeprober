...
- "any" - any datastructure at all. Used b
...
| cpr_nodeLabel                  | String                       | null          | A label that is shown in the UI rather than the actual Java class of the node. Highly related to `cpr.type_identification_style` in [system_properties](system_properties).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | ast   |
