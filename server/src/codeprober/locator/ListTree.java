...
////				return new ListedTreeNode(null, locator, null, null)
//			} else {
...
//			final NodeLocatorStep edge = edges.mergedEdges.get(i);
...
//		}
//
//		return listDownwardsWithInjects(info, edges.mergedEdges.isEmpty() ? node : edges.mergedEdges.get(0).sourceNode,
//				budget, forceExploreAndInjects);
//	}
//}
