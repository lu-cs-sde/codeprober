...
public class ListedTreeChildNode implements codeprober.util.JsonUtil.ToJsonable {
  ...
  public static ListedTreeChildNode fromJSON(JSONObject obj) {
    ...
    case children:
      try {
        final java.util.List<ListedTreeNode> val = codeprober.util.JsonUtil.<ListedTreeNode>mapArr(obj.getJSONArray("value"), (arr24, idx24) -> ListedTreeNode.fromJSON(arr24.getJSONObject(idx24)));
  ...
  public void writeTo(codeprober.protocol.BinaryOutputStream dst) throws java.io.IOException {
    ...
    switch (type) {
    case children:
      codeprober.util.JsonUtil.<ListedTreeNode>writeDataArr(dst, ((java.util.List<ListedTreeNode>)value), ent24 -> ent24.writeTo(dst));
      break;
    case placeholder:
    default:
