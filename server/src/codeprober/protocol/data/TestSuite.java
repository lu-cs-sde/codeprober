...
public class TestSuite implements codeprober.util.JsonUtil.ToJsonable {
  ...
  public static TestSuite fromJSON(JSONObject obj) {
    return new TestSuite(
      obj.getInt("v")
    , codeprober.util.JsonUtil.<TestCase>mapArr(obj.getJSONArray("cases"), (arr1, idx1) -> TestCase.fromJSON(arr1.getJSONObject(idx1)))
    );
  }
  ...
  public void writeTo(codeprober.protocol.BinaryOutputStream dst) throws java.io.IOException {
    dst.writeInt(v);
    codeprober.util.JsonUtil.<TestCase>writeDataArr(dst, cases, ent1 -> ent1.writeTo(dst));
  }
}
