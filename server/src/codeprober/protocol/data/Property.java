...
public class Property implements codeprober.util.JsonUtil.ToJsonable {
  ...
  public static Property fromJSON(JSONObject obj) {
    return new Property(
      obj.getString("name")
    , obj.has("args") ? (codeprober.util.JsonUtil.<PropertyArg>mapArr(obj.getJSONArray("args"), (arr23, idx23) -> PropertyArg.fromJSON(arr23.getJSONObject(idx23)))) : null
  ...
  public void writeTo(codeprober.protocol.BinaryOutputStream dst) throws java.io.IOException {
    dst.writeUTF(name);
    if (args != null) { dst.writeBoolean(true); codeprober.util.JsonUtil.<PropertyArg>writeDataArr(dst, args, ent23 -> ent23.writeTo(dst));; } else { dst.writeBoolean(false); }
