...
public class ListedTreeNode implements codeprober.util.JsonUtil.ToJsonable {
  ...
  public static ListedTreeNode fromJSON(JSONObject obj) {
    ...
    , obj.has("remotes") ? (codeprober.util.JsonUtil.<NodeLocator>mapArr(obj.getJSONArray("remotes"), (arr, idx) -> NodeLocator.fromJSON(arr.getJSONObject(idx)))) : null
    );
  }
  ...
  public void writeTo(codeprober.protocol.BinaryOutputStream dst) throws java.io.IOException {
    ...
    if (remotes != null) { dst.writeBoolean(true); codeprober.util.JsonUtil.<NodeLocator>writeDataArr(dst, remotes, ent -> ent.writeTo(dst));; } else { dst.writeBoolean(false); }
  }
}
