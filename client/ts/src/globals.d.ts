...
type HelpType = 'general' | 'recovery-strategy' | 'probe-window' | 'magic-stdout-messages'
  ...
  | 'capture-traces' | 'location-style' | 'textprobe-style' | 'ast' | 'test-code-vs-codeprober-code' | 'auto-shorten-property-names'
  ;
